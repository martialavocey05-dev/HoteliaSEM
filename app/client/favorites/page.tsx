...
import { ArrowLeft, MapPin, Star, Wifi, Car, UtensilsCrossed, Waves, Heart, Calendar, Sparkles } from 'lucide-react'
...
const allHotels = [
  {
    ...
    rating: 4.9,
    price: "85 000",
    description: "Vivez le luxe au coeur de la capitale économique.",
    features: [
  ...
  },
  {
    ...
    rating: 4.8,
    price: "120 000",
    description: "Élégance et raffinement dans la capitale politique.",
    features: [
  ...
  },
  {
    ...
    rating: 4.7,
    price: "95 000",
    description: "Paradis tropical au bord de l'océan.",
    features: [
        ...
        <main className="mx-auto max-w-7xl px-6 py-12">
          <div className="mb-8 animate-fade-in-up">
            <div className="flex items-center gap-3 mb-2">
              <Heart className="h-8 w-8 fill-red-500 text-red-500 animate-glow-pulse" />
            ...
            <p className="text-foreground/70">
              {favoriteHotels.length === 0
                ...
                : `${favoriteHotels.length} hôtel${favoriteHotels.length > 1 ? 's' : ''} dans vos favoris`}
            </p>
          </div>
            ...
            <Card className="glass-card border-hsem-silver/20 animate-scale-in">
              <CardContent className="flex flex-col items-center justify-center py-16">
                <div className="rounded-full bg-primary/10 p-6 mb-4">
                  <Sparkles className="h-12 w-12 text-primary animate-silver-float" />
                </div>
                <h3 className="font-serif text-2xl font-bold text-hsem-gold mb-2">
                  Commencez votre collection
                </h3>
                <p className="text-foreground/70 text-center max-w-md mb-6">
                  Explorez nos hôtels et ajoutez vos préférés à votre liste de favoris pour les retrouver facilement
                </p>
                <Button
